...
public interface HistoryService {
    ...
    void addHometownsForPeriod(HometownHistoryDTO archive, HometownHistoryDTO localArchive, int startYear, int endYear, List<String> possibleCitiesForMoves);
    ...
    void updateHistoryDTO(HistoryDTO historyDTO);
}
