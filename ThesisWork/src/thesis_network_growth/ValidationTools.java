...
public class ValidationTools {
	...
	// ---------- Overloaded 'empty' functions ---------- //
		// Each empty() function is simply tasked with checking whether or not the given (parameter) variable has been initialized with a value.  
		public static boolean empty (int var) {
			//System.out.println(var + "  \t|\t  " + (var == Integer.MIN_VALUE));
			return var == Integer.MIN_VALUE;
		} // end empty()
		public static boolean empty (double var) {
			//System.out.println(var + "  \t|\t  " + (var == Double.MIN_VALUE));
			return var == Double.MIN_VALUE;
		} // end empty()
		public static boolean empty (String var) {
			//System.out.println(var + "  \t|\t  " + (var == null));
			return var == null;
		} // end empty()
		public static boolean empty (Boolean var) {
			return var == null;
		} // end empty()
		public static boolean empty (int[] var) {
			//System.out.println(var + "  \t|\t  " + (var == null));
		...
		public static boolean empty (ArrayList var) {
			return var == null;
		} // end empty()
