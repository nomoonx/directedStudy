	...
	*/
	...
	public static void LoadConfigValuesFromFile (String filename) {
		...
		try {
			...
			OtherCities = ArrayTools.stringArrayToArrayList(xmlReader.getStringArray("OtherCities"));
			AllCities = ArrayTools.stringArrayToArrayList(xmlReader.getStringArray("AllCities"));
